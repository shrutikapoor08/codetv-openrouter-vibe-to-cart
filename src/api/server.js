...
import {
  ...
  getImageAnalysisCacheStatsRoute,
  clearImageAnalysisCacheRoute,
...
app.get("/api/image-analysis-cache-stats", getImageAnalysisCacheStatsRoute);
app.post("/api/clear-image-analysis-cache", clearImageAnalysisCacheRoute);
